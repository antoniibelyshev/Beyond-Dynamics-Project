...
def create_trajectories(N_traj=200, traj_len=200, save=True, r_range=(0.2, 2), path="../data"):
    """
    ...
    if save:
        np.savez(f"{path}/harmonic_oscillator.npz", data=data, params=energies[:, None])
