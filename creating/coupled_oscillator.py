...
def create_trajectories(N_traj=200, traj_len=200, save=True, E1_rng=(0.2, 2), E2_rng=(0.2, 2), path="../data"):
    """
    ...
    if save:
        np.savez(f"{path}/coupled_oscillator", data=data, params=np.stack((energies1, energies2), axis=1))
